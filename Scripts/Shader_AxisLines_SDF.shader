Shader "Unlit/Shader_Graphics_AxisLines_SDF_Plane"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (PixelData i) : SV_Target
            {
                ...
                float xAxis =  smoothstep(AxisThickness, 0.00, abs(coordinateShade.y));
                float yAxis =  smoothstep(AxisThickness, 0.00, abs(coordinateShade.x));
